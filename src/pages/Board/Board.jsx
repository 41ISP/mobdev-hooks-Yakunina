...
const PageBoard = () => {
    ...
    useEffect(() => {
        showCompleted ? setShownTasks(tasks.filter(el => el.done)) 
        : setShownTasks(tasks)
    ...
    const handleSubmit = (e) => {    
        ...
        if (taskField.trim().length === 0 || taskField.trim > 5) return
            ...
            <div className="board-toolbar">
                <div className="mount-wrap" data-hook="1.2 useState (toggle)">
                    <div
                        ...
                        <span onClick={() => setShowCompleted(o => !o)}
            ...
            <div
                ...
                <div className="mount-point" id="mount-tasklist">
                    ...
                    <div className="task-list">
                        ...
                        {shownTasks.map((task, i) => <TaskRow {...task} key ={i} setTasks={setTasks} />)}
